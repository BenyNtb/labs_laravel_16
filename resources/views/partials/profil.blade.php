            ...
            <div
                ...
                <div class="col-span-3 row-span-1">
                    <div class="flex items-center justify-center p-2 md:p-4">
                        <h1 class="text-lg">
                            ...
                            Role : <span class="text-purple-500 font-bold">{{ Auth::user()->role->nom }}</span>
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-span-3 row-span-1">
                    <div class="flex items-center justify-center p-2 md:p-4">
                        ...
                        <a class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full"
                            href="{{ route('password.request') }}">Edit password</a>
                    </div>
                </div>
