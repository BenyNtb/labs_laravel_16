                        ...
                        <table class="w-full">
                            ...
                            @foreach ($contacts as $contact)
                                <tr class="border-2">
                                    ...
                                    <td class="py-4 px-6 border-b border-grey-light">{{ $contact->adresse1 }} {{ $contact->adresse2 }} </td>
                                    <td class="py-4 px-6 border-b border-grey-light">{{ $contact->telephone }}</td>
                                    <td class="py-4 px-6 border-b border-grey-light">{{ $contact->mail }}</td>
                                    ...
                                    <td class="flex">
                                        <a href="{{route('contact.edit', $contact) }}" class="w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white mr-1 px-3 py-2">Edit</a>
                                    </td>
                                </tr> 
                            @endforeach
                        </table>
