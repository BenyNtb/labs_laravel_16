<x-app-layout>
    ...
    <div class="content" >
        ...
        <div class="grid mt-8  gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
            <form method="POST" action="{{route('discover.update', $discover->id)}}">
                @csrf
                @method('PUT')
                    ...
                    <div class="bg-white shadow-md  rounded-3xl p-4">
                        <div class="flex-none lg:flex">
                            ...
                            <div class="flex-auto ml-3 justify-evenly py-2">
                                <input id="titre" name="titre" value="{{$discover->titre}}" class="border border-gray-400 p-2 rounded-lg" x-model="currentColor">
                                    @error('titre')
